...
<title>SPIRA - Acesso ao sistema</title>
...
<div class="login-form">
    <form action="<?php echo base_url(); ?>login/process" method='post' name='process'>    
		<div class="avatar">			
			<img src="<?php echo base_url(); ?>img/logo-spira.svg" alt="SPIRA">
		</div>
        
        <?php if(! is_null($msg)){ ?>
            <div class="alert alert-danger alert-dismissible fade show alert-pos text-center" role="alert">
              <strong>Login e senha inválidos</strong> 
